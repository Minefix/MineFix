...
local c_glowstone = minetest.get_content_id("minefix_nether:glowstone")
local c_sand_soul = minetest.get_content_id("minefix_nether:sand_soul")
local c_netherbrick = minetest.get_content_id("minefix_nether:brick")
local c_netherrack = minetest.get_content_id("minefix_nether:rack")
...
function make_portal(pos)
	...
	for y = p1.y, p2.y do
		...
		if minetest.get_node(p).name == "air" then
			minetest.set_node(p, {name = "minefix_nether:portal", param2 = param2})
		end
